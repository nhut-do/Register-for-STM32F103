...
{
	USART1->CR1 |= (1 << 5);												// Enable generated interrupt for USART1 reciever
	NVIC->ISER[1] |= (1 << 5);											// Enable IRQ37 for USART1 global interrupt
}

void USART2_EnableInterrupt(void)
{
	USART2->CR1 |= (1 << 5);												// Enable generated interrupt for USART2 reciever
	NVIC->ISER[1] |= (1 << 6);											// Enable IRQ38 for USART2 global interrupt
}

void USART3_EnableInterrupt(void)
{
	USART3->CR1 |= (1 << 5);												// Enable generated interrupt for USART3 reciever
	NVIC->ISER[1] |= (1 << 7);											// Enable IRQ39 for USART3 global interrupt
}
